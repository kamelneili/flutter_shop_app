...
import 'package:technoshop/logic/models/order.dart';
import 'package:technoshop/ui/screens/order_details/order_details.dart';
          ...
          InkWell(
            child: Container(
              padding: EdgeInsets.symmetric(
                horizontal:  30, //px padding
                vertical:  5 //px padding
              ),
...
InkWell(
                 ...
                 child: Container(
                   padding: EdgeInsets.symmetric(
                     horizontal:30,// kDefaultPadding * 1, // 30 px padding
